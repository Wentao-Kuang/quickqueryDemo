...
require 'connect.php';
	...
	if ($action == 'entity') {
    try {
        $requestURL = 'https://sandbox-quickbooks.api.intuit.com/v3/company/' . $_SESSION['company_id'] . '/account/' . $_POST['entityId'];
                ...
                <div class="contact-form">
                    ...
                    <form id="contact-us" method="post" action="?action=entity">
                    	 <div class="col-xs-8 wow animated slideInLeft" data-wow-delay=".5s">
                            <!-- Name -->
                        <label>Please Enter Account ID:</label>
                            <!-- Email -->
                        </div><!-- End Left Inputs -->
                        <!-- Left Inputs -->
                        <div class="col-xs-8 wow animated slideInLeft" data-wow-delay=".5s">
                        ...
                        <div class="col-xs-4 wow animated slideInRight" data-wow-delay=".5s">
                            <!-- Message -->
                            <button type="submit" id="submit" name="submit" class="form-btn semibold">Read</button>
